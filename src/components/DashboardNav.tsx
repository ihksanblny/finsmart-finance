  ...
  return (
    <aside className="w-64 fixed inset-y-0 left-0 bg-white border-r border-zinc-200 z-50 flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
      ...
      <div className="flex-1 py-8 px-4 flex flex-col gap-2 overflow-y-auto">
        ...
        <Link 
          to="/market" 
          className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${isActive('/market') ? 'bg-zinc-100 text-zinc-900 shadow-sm' : 'text-zinc-500 hover:bg-zinc-50 hover:text-zinc-900'}`}
        >
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
