...
export default function Login() {
  ...
  return (
    <AuthLayout 
      ...
      subtitle="Access your personal career & inflation analytics dashboard."
    >
      <div className="mb-6">
        {error && (
      ...
      <form onSubmit={handleLogin} className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex justify-between items-center">
             ...
             <a href="#" className="text-xs text-zinc-500 hover:text-zinc-900 transition-colors font-semibold">Forgot Password?</a>
          </div>
          <input 
            type="password" 
            placeholder="••••••••"
        ...
        <button 
          type="submit"
          disabled={loading}
          className="w-full py-4 mt-2 rounded-lg bg-zinc-900 text-white font-bold text-lg hover:bg-black disabled:opacity-70 transition-all flex items-center justify-center group"
        >
